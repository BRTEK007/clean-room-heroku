...
class Game {
  ...
  addPlayer(id, socket) {
    this.players[id] = new Player(id, PLAYER_TEMPLATE[id]);
    this.playerIdDictionary.set(socket, id);
  }

  respawnPlayer(player) {
    player.pos.x = PLAYER_TEMPLATE[player.id].x;
    player.pos.y = PLAYER_TEMPLATE[player.id].y;
    player.respawn();
  }
...
module.exports.player_template = PLAYER_TEMPLATE;
