...
module.exports = class Player extends Entity{
    constructor(_game, _id, _xp, _yp, _nick, _color) {
      ...
      this.rigidbody = new RigidBody(this.transform, {drag: 0.99});
    ...
    update(delta) {
      ...
      this.transform.rotation += this.client_input.x*this.rotation_speed;

      let direction = this.transform.getForwardVec();

      this.rigidbody.addForce(-this.client_input.y * direction.x * this.speed, -this.client_input.y * direction.y * this.speed);
